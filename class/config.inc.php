...
$config->APPID		= '198419';	//你的API Key，请自行申请
$config->APIKey		= '4176201c73cf4fe4acad7e7acd436443';	//你的API Key，请自行申请
$config->SecretKey	= '9769836698c64a6785c51deff512c1f6';	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml

$config->redirecturi= 'http://apps.renren.com/thu_badge/';//授权成功之后的跳转地址
